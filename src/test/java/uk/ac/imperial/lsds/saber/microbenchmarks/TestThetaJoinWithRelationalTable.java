...
public class TestThetaJoinWithRelationalTable {
	...
	public static void main(String [] args) {
		...
		Query query = new Query (0, operators, schema1, window1, true, schema2, window2, false, queryConf, timestampReference);
