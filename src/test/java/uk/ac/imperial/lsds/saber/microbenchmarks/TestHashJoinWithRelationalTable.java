...
public class TestHashJoinWithRelationalTable {
	...
	public static void main(String [] args) {
		...
		SystemConf.RELATIONAL_TABLE_BUFFER_SIZE = tupleSize2 * tuplesPerInsert;
		// set the window on the relational table correctly
		// WindowDefinition window1 = new WindowDefinition (windowType1, windowRange1, windowSlide1);
		WindowDefinition window2 = new WindowDefinition (WindowType.ROW_BASED, tuplesPerInsert, tuplesPerInsert);
		...
		IOperatorCode cpuCode = new HashJoin (schema1, schema2, predicate);
		...
		Query query = new Query (0, operators, schema1, window1, false, schema2, window2, true, queryConf, timestampReference);
